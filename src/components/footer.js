      ...
      <div className="footer-max-width max-content-container">
        ...
        <div className="footer-bottom-container">
          <div className="footer-left-side">
            ...
            <div className="footer-social-media">
              <span className="footer-text15">Follow market1</span>
          ...
          <div className="footer-links">
            <div className="footer-container2">
              <span className="footer-text16">Product</span>
              ...
              <span className="footer-text22 footer-link">Workshops</span>
            </div>
            <div className="footer-container3">
              ...
              <span className="footer-text30 footer-link">sales</span>
            </div>
          </div>
        </div>
        <div className="footer-copyright">
          <span className="footer-text31">
            ...
            >
              <span className="footer-text35">@TeleportHQ.</span>
            </a>
            <span>
              <span>
                {' '}
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className="footer-text39">Vercel</span>
            </a>
            <span>
              <span>
                . Image source:
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className="footer-text43">Unsplash</span>
            </a>
            <span>.</span>
          </span>
        </div>
